...
newTrial( "intro" ,
    newImage("logo.png")
        ...
        .print()
    ,
    newText("<p>Welcome to the second main task.</p><p>Please enter your experiment ID below and press Enter:</p>")
        .print()
    ,
    newTextInput()
        .print()
...
newTrial("intro2",
    defaultText
        .print()
    ,
    newText("<p>Hello again!</p>")
    ,
    newText("<p>In this experiment, you will hear a series of letter strings. </p>")
    ,
